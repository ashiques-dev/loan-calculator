import { z } from "zod";
import { TCalculatorFormFields } from "./types";

export const NavLinks = [
  { label: "Home", link: "/" },
  { label: "Exchange Rates", live: true, link: "/exchange" },
  { label: "About", link: "/about" },
  { label: "Error Page", link: "/error" },
];

export const calculatorFormFields: TCalculatorFormFields = [
  { label: "Loan Amount", id: "amount" },
  { label: "Interest Rate", id: "rate" },
  { label: "Term (Years)", id: "years" },
];
...
export const calculatorFormSchema = z.object({
  ...
  rate: z
    ...
    .refine((val) => !isNaN(parseFloat(val)) && parseFloat(val) >= 0.01, {
      message: `Interest rate must be at least more than 0.01%`,
    }),
  years: z
    .string()
    .refine((val) => !isNaN(parseFloat(val)) && parseFloat(val) >= 1, {
      message: `Years must be at least one`,
    }),
});
...
export const countriesList = [
  ...
  { currencyCode: "FJD", currencyName: "Fiji Dollar", country: "Fiji" },
  {
    currencyCode: "FKP",
  ...
  { currencyCode: "WST", currencyName: "Samoan Tālā", country: "Samoa" },
  {
    currencyCode: "XAF",
